...
public class GenericQuestionnaireToListTextService : IQuestionnaireToTextService
{
    public string CreateText(QuestionnaireResponse response, Questionnaire questionnaire)
    {
        ...
        if (sb.Length == 0 && response.Item != null)
        {
        ...
        // Each question: answer pair is on a new line
